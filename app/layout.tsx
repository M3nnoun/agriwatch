...
export const metadata: Metadata = {
  ...
  description:
    'Satellite crop monitoring, AI early warning, and automatic micro-insurance payouts for smallholder farmers — delivered to any phone, in any language, with no app to install.',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* Display serif for editorial headlines (loaded at runtime, no build dependency) */}
